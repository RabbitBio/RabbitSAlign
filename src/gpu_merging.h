...
__global__ void gpu_rescue_merge_hits_get_nams_2(int num_tasks, IndexParameters *index_para, bool is_revcomp, my_vector<my_pair<int, Hit>>* hits_per_ref0s,  my_vector<int> *global_each_ref_size0, int* each_ref_info0, my_vector<Nam> *global_nams_temp);
