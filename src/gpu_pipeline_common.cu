...
thread_local double gpu_cost4_1 = 0;
thread_local double gpu_cost4_2 = 0;
thread_local double gpu_cost4_3 = 0;
thread_local double gpu_cost4_4 = 0;
thread_local double gpu_cost4_5 = 0;
thread_local double gpu_cost4_6 = 0;
thread_local double gpu_cost4_7 = 0;
thread_local double gpu_cost5 = 0;
thread_local double gpu_cost6 = 0;
thread_local double gpu_cost6_1 = 0;
thread_local double gpu_cost6_2 = 0;
thread_local double gpu_cost6_3 = 0;
thread_local double gpu_cost6_4 = 0;
thread_local double gpu_cost7 = 0;
thread_local double gpu_cost7_1 = 0;
thread_local double gpu_cost7_2 = 0;
thread_local double gpu_cost7_3 = 0;
thread_local double gpu_cost7_4 = 0;
thread_local double gpu_cost7_5 = 0;
thread_local double gpu_cost7_6 = 0;
thread_local double gpu_cost7_7 = 0;
thread_local double gpu_cost8 = 0;
thread_local double gpu_cost8_1 = 0;
thread_local double gpu_cost8_2 = 0;
thread_local double gpu_cost8_3 = 0;
thread_local double gpu_cost8_4 = 0;
...
void init_shared_data(const References& references, const StrobemerIndex& index, const int gpu_id, int thread_id) {
    ...
    if (gpu_id == 0) fprintf(stderr, "init_shared_data thread_id = %d, gpu_id = %d\n", thread_id, gpu_id);
...
void init_global_big_data(int thread_id, int gpu_id, int max_tries, int batch_read_num) {
    ...
    if (gpu_id == 0) fprintf(stderr, "global_align_res_data_size -- %llu\n", global_align_res_data_size);
    ...
    if (gpu_id == 0) fprintf(stderr, "--- align_res GPU mem alloc %llu\n", batch_read_num * 2 * sizeof(GPUAlignTmpRes) * 3
...
void init_seg_sort_resources(
    ...
    fprintf(stderr, "pre alloc seg sort key/value size %.2f MB\n", 4.0 * initial_bytes / 1024 / 1024);
...
//    fprintf(stderr, "pre alloc seg sort nam temp size %.2f MB\n", 1.0 * nam_temp_bytes / 1024 / 1024);
